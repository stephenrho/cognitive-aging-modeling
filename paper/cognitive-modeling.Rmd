...
<!--
Nate: I trimmed this paragraph on the Loitile study down considerably. It slipped my mind when I intended to include it that it technically was not an aging study, though it is aging-adjacent. We could cut it all together or leave it.
-->
...
<!--In other words, more than half of all cognitive aging studies published in one of the field's top journals do not report age differences on an outcome that is a measure of a latent process!-->
...
<!--
steve: I commented out the line ending in an ! as 2020 was (technically) 51% 
Also I think this doesn't quite gel with the footnote below saying that non-modeling work is also valuable too 
-->
...
<!--
Nate: The table now is too large to fit on one page, so it has cut off the information I add on reinforcement learning models.
-->
...
<!--
Nate's response: I commented that sentence out. I'm fine with dropping it all together.
-->
...
<!--
Nate's response: I think leaving the two Rotello parts in are fine, as I've managed to condense the ms. down to under 8000 words
-->
...
<!--
Nate's response: I have made all these changes.
-->
